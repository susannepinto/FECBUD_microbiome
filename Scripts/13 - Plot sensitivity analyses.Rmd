...
load("/Volumes/My Passport for Mac/FECBUD studie/FECBUD GitHub/Data/Scenario1.Rda")
Scenario1 <- results.all.count
load("/Volumes/My Passport for Mac/FECBUD studie/FECBUD GitHub/Data/Scenario2.Rda")
Scenario2 <- results.all.count
load("/Volumes/My Passport for Mac/FECBUD studie/FECBUD GitHub/Data/Scenario2_sens.Rda")
Scenario2_sens <- results.all.count
load("/Volumes/My Passport for Mac/FECBUD studie/FECBUD GitHub/Data/Scenario3.Rda")
Scenario3 <- results.all.count
load("/Volumes/My Passport for Mac/FECBUD studie/FECBUD GitHub/Data/Scenario3_sens.Rda")
Scenario3_sens <- results.all.count

names(Scenario1)[names(Scenario1) == 'n'] <- 'Sensitivity 2'
names(Scenario2)[names(Scenario2) == 'n'] <- 'Base case'
names(Scenario2_sens)[names(Scenario2_sens) == 'n'] <- 'Sensitivity 1'
names(Scenario3)[names(Scenario3) == 'n'] <- 'Sensitivity 3'
names(Scenario3_sens)[names(Scenario3_sens) == 'n'] <- 'Sensitivity 4'

jointdataset <- merge(Scenario1, Scenario2, by = c("Patient_ID", "State", "Donor", "Pretreatment", "Age", "Sex", "timepoint", "category" ))
jointdataset <- merge(jointdataset, Scenario2_sens, by = c("Patient_ID", "State", "Donor", "Pretreatment", "Age", "Sex", "timepoint", "category" ))
jointdataset <- merge(jointdataset, Scenario3, by = c("Patient_ID", "State", "Donor", "Pretreatment", "Age", "Sex", "timepoint", "category" ))
jointdataset <- merge(jointdataset, Scenario3_sens, by = c("Patient_ID", "State", "Donor", "Pretreatment", "Age", "Sex", "timepoint", "category" ))
```
...
```{r models scenario 1, results = FALSE}
...
```{r models scenario 2 sens, results = FALSE}
...
```{r models scenario 3, results = FALSE}
...
```{r models scenario 3 sens, results = FALSE}
...
```{r plot scenario 2 with splines}
custom_order <- c("categoryResident", "categoryHost Transient", "categorySpecies loss",
                  "categoryColonisation", "categoryDonor Transient", "categoryRejection",
                  "categoryNovel", "categoryNovel Transient", "categoryNovel loss",
...
```{r plot sums all scenarios together}
custom_order <- c("categoryResident", "categoryHost Transient", "categorySpecies loss",
                  "categoryColonisation", "categoryDonor Transient", "categoryRejection",
                  "categoryNovel", "categoryNovel Transient", "categoryNovel loss",
                  "DonorDonor B", "Pretreatmentplacebo", "SexM", "Age2",
...
```{r plot all scenario 1 timelines}
library(gamlss)
library(ggplot2)
...
```{r plot all scenario 2 timelines}
library(gamlss)
library(ggplot2)
...
```{r plot all scenario 2 sens timelines}
library(gamlss)
library(ggplot2)
...
```{r plot all scenario 3 timelines}
library(gamlss)
library(ggplot2)
...
```{r plot all scenario 3 sens timelines}
library(gamlss)
library(ggplot2)
